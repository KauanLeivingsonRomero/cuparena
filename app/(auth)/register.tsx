  ...
  return (
    <View className='flex h-full bg-off-black pb-4'>
      ...
      <View className='flex h-full bg-off-black items-center pt-5'>
        ...
        {errors.name ? <Animated.Text entering={FadeInUp.duration(400)} exiting={FadeInUp.duration(400)} className='text-red-500 pt-2'>{String(errors.name.message)}</Animated.Text> : null}
        ...
        {errors.password ? <Animated.Text entering={FadeInUp.duration(400)} exiting={FadeInUp.duration(400)} className='text-red-500 pt-2'>{String(errors.password.message)}</Animated.Text> : null}
