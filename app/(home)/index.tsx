...
import { Text, ScrollView, View, Image, TouchableOpacity, RefreshControl } from 'react-native';
          ...
          <View className='w-screen bg-main-black pl-5 pr-5 pt-5 flex flex-row justify-between items-center'>
            ...
            <View>              
              <TouchableOpacity className='rounded-full'>
                ...
                {active ? <View className='w-2 h-2 bg-red-500 rounded-full absolute top-0 right-0' /> : null }
              </TouchableOpacity>
            </View>
          </View>
        </View>
